...
printf "\e[1;77m[\e[0m\e[1;31m+\e[0m\e[1;77m This technique consists of \e[1;31m following/unfolling \e[1;77m celebgrams\e[0m\n"
...
if [[ ! -e celeb_id ]]; then
printf "%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n" $rixonxavier $mileycyrus $shawnmendes $techcochi $charlieputh $lelepons $camila_cabello $madonna $leonardodicaprio $ladygaga $taylorswift $instagram $neymar $selena $ariana $beyonce $cristiano $kimkardashian $kendall $therock $kylie $jelopez $messi > celeb_id
fi
...
printf "\n"
printf " \e[1;101m\e[1;97m01\e[1;101m\e[0m\e[1;96m Unfollow Tracker\e[0m\n"
printf " \e[1;101m\e[1;97m02\e[1;101m\e[0m\e[1;96m Increase Followers\e[0m\n"
printf " \e[1;101m\e[1;97m03\e[1;101m\e[0m\e[1;96m Download Stories\e[0m\n"
printf " \e[1;101m\e[1;97m04\e[1;101m\e[0m\e[1;96m Download Saved Content\e[0m\n"
printf " \e[1;101m\e[1;97m05\e[1;101m\e[0m\e[1;96m Download Following List\e[0m\n"
printf " \e[1;101m\e[1;97m06\e[1;101m\e[0m\e[1;96m Download Followers List\e[0m\n"
printf " \e[1;101m\e[1;97m07\e[1;101m\e[0m\e[1;96m Download Profile Info\e[0m\n"
printf " \e[1;101m\e[1;97m08\e[1;101m\e[0m\e[1;96m Activate Unfollower\e[0m\n"
printf "\n"
